...
class CRYPTOPP_DLL DefaultEncryptor : public ProxyFilter
{
public:
...
class CRYPTOPP_DLL DefaultDecryptor : public ProxyFilter
{
public:
...
class CRYPTOPP_DLL DefaultEncryptorWithMAC : public ProxyFilter
{
public:
...
class CRYPTOPP_DLL DefaultDecryptorWithMAC : public ProxyFilter
{
public:
