...
string Utils::StringHelpers::toLower(const string &s)
{
    string ret;
...
string Utils::StringHelpers::toUpper(const string &s)
{
    string ret;
    for(int i = 0; i < (int)s.length(); i++)
...
string Utils::StringHelpers::baseName(const string &s)
{
...
string Utils::StringHelpers::pathName(const string &s)
{
...
string Utils::StringHelpers::toBase16(const string &s)
{
    string res;
...
string Utils::StringHelpers::fromBase16(const string &s)
{
    if(s.size() % 2 != 0)
    {
        THROW_GUTIL_EXCEPTION( Exception("Input string was not in the correct format") )
    }
...
string Utils::StringHelpers::toBase64(const string &instr)
{
    string outstr = "";
...
string Utils::StringHelpers::fromBase64(const string &instr)
{
    ...
    if(instr.length() % 4)
    {
        THROW_GUTIL_EXCEPTION( Exception("Input string is not the right length") )
    }
    ...
    for(int i = 0; i < len; i += 4)
    {
        ...
        if(it == charmap.end())
        {
            THROW_GUTIL_EXCEPTION( Exception("Unrecognized base-64 character") )
        }
        ...
        if(tmp3 != base64_padding)  // Equal signs are padding in base64
        {
            ...
            {
                THROW_GUTIL_EXCEPTION( Exception("String is in unrecognized format") )
            }
        }
...
char Utils::StringHelpers::charToHex(char c)
{
    ...
    {
        THROW_GUTIL_EXCEPTION( Exception("Unrecognized hex character") )
    }

    return ret;
}

char Utils::StringHelpers::hexToChar(char c)
{
    char ret;
    ...
    if(0 != (c & 0xf0))
    {
        THROW_GUTIL_EXCEPTION( Exception("Unrecognized hex digit") )
    }
...
void Utils::StringHelpers::showBits(char c, ostream &str)
{
