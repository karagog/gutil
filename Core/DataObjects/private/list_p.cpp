...
list_p::list_p(list_p::list_type_wrapper *tw)
    :data_wrapper(tw),
      m_size(0)
{}

void list_p::push_front(const void *const v)
{
...
void list_p::push_back(const void *const v)
{
    bidirectional_node_t *new_node(new bidirectional_node_t);
...
list_p &list_p::CloneTo(list_p &object) const
{
