...
namespace GQtUtil
{
    namespace DataAccess
    {
        ...
        class DA_LocalClientServer_Base : public Private::DA_ValueBuffer_P
        {
            Q_OBJECT
        signals:
        ...
        protected:
            ...
            DA_LocalClientServer_Base(const QString &, const QString &, QObject *parent = 0);
            ~DA_LocalClientServer_Base();
            ...
            Private::Transports::SocketTransport *_transport;

        private slots:
            void messageArrived(QUuid, const QByteArray &);

        private:
            void _send_message(QPointer<DA_LocalClientServer_Private::socket_worker>,
                               const QList<parameter_t> &);
            void _process_control_parameter(QUuid, parameter_t);

            // Keep track of a list of socket workers
            QMap< QUuid, QPointer< DA_LocalClientServer_Private::socket_worker > > worker_list;
        ...
        class DA_LocalServer : public DA_LocalClientServer_Base
        {
            Q_OBJECT
        protected:
        ...
        // Use this class as the client endpoint
        class DA_LocalClient : public DA_LocalClientServer_Base
        {
            Q_OBJECT
        protected:
            explicit DA_LocalClient(const QString &identifier,
                                    const QString &modifier,
                                    QObject *parent = 0);

            void sendMessage(const QList<parameter_t> &);
        };
    }
}
