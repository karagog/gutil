...
#include "giodevice.h"
#include "Core/DataObjects/pairlist.h"
#include "Core/DataObjects/collection.h"
...
private:
    ...
    inline void SendData(const QByteArray &d){ GIODevice::SendData(d); }
    inline QByteArray ReceiveData(bool){ return GIODevice::ReceiveData(); }
...
protected:
    ...
    GUtil::DataObjects::ResizableCollection<GDatabaseIODevice::ColumnOptions>
    _column_options;
